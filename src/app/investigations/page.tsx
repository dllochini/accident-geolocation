...
export default function InvestigationsPage() {
  ...
  const [filterStatus, setFilterStatus] = useState<InvestigationStatus | "all">(
    "all",
  );
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-slate-600 mt-1">
                Manage and review all accident investigations.
              </p>
            </div>
            <Link
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFilterStatus(
                      e.target.value as InvestigationStatus | "all",
                    )
                  }
                ...
                <table className="w-full min-w-[900px] table-fixed">
                  <thead>
                    <tr className="border-b border-slate-200 bg-slate-50">
                      <th className="w-[14%] text-left px-4 py-3 font-semibold text-slate-900 text-sm">
                        Case ID
                      </th>

                      <th className="w-[12%] text-left px-4 py-3 font-semibold text-slate-900 text-sm">
                        Created
                      </th>

                      <th className="w-[22%] text-left px-4 py-3 font-semibold text-slate-900 text-sm">
                        Description
                      </th>

                      <th className="w-[18%] text-left px-4 py-3 font-semibold text-slate-900 text-sm">
                        Location
                      </th>
                      ...
                      <th className="w-[10%] text-left px-4 py-3 font-semibold text-slate-900 text-sm">
                        Actions
                      </th>
                    </tr>
                  </thead>
